...
Button(main, text='BERT', command=bert_ans).grid(row=4, column=3, sticky=W)
Button(main, text='Clear', command=clear).grid(row=4, column=4, sticky=W)
